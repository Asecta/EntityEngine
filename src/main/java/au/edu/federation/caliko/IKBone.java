...
public class IKBone implements Serializable {
     ...
     * to another chain via the {@link IKStructure#connectChain(IKChain, int, int, BoneConnectionPoint)} method.
     */
     ...
     */
    private IKJoint mJoint = new IKJoint();
     ...
     * method provided by the {@link IKChain} class.
     */
     ...
     * 'addBone' method provided by the {@link IKChain} class.
     */
     ...
     *
     * @see #setName(String)
     * @see #IKBone(Vector3f, Vector3f, String)
     * @see #IKBone(Vector3f, Vector3f, float, String)
     */
     ...
     */
    public IKBone(Vector3f startLocation, Vector3f endLocation) {
     ...
     * calls the {@link #IKBone(Vector3f, Vector3f)} constructor.
     *
     * @param startLocation The start location of this bone.
     * @param endLocation   The end location of this bone.
     * @param name          The name of this bone.
     */
    public IKBone(Vector3f startLocation, Vector3f endLocation, String name) {
     ...
     */
    public IKBone(Vector3f startLocation, Vector3f directionUV, float length) {
        // Sanity checking
        ...
        mEndLocation.set(mStartLocation.add(directionUV.normalize().mul(length), new Vector3f()));
    }
     ...
     * <p>
     * This constructor is merely for convenience if you intend on working with named bones, and internally
     * calls the {@link #IKBone(Vector3f, Vector3f, float)} constructor.
     * <p>
     ...
     * @param name          The name of this bone.
     */
    public IKBone(Vector3f startLocation, Vector3f directionUV, float length, String name) {
    ...
    public float liveLength() {
        return mStartLocation.distance(mEndLocation);
    }
    ...
    public float[] getStartLocationAsArray() {
        return new float[]{mStartLocation.x, mStartLocation.y, mStartLocation.z};
    }
    ...
    public float[] getEndLocationAsArray() {
        return new float[]{mEndLocation.x, mEndLocation.y, mEndLocation.z};
    }
    ...
    public void setHingeJointClockwiseConstraintDegs(float angleDegs) {
        mJoint.setHingeJointClockwiseConstraintDegs(angleDegs);
    }
    ...
    public float getHingeJointClockwiseConstraintDegs() {
        return mJoint.getHingeClockwiseConstraintDegs();
    }
    ...
    public void setHingeJointAnticlockwiseConstraintDegs(float angleDegs) {
        mJoint.setHingeJointAnticlockwiseConstraintDegs(angleDegs);
    }
    ...
    public float getHingeJointAnticlockwiseConstraintDegs() {
        return mJoint.getHingeAnticlockwiseConstraintDegs();
    }
    ...
    public float getBallJointConstraintDegs() {
        return mJoint.getBallJointConstraintDegs();
    }
    ...
    public Vector3f getDirectionUV() {
        return VectorUtils.getDirectionUV(mStartLocation, mEndLocation);
    }
    ...
    public float getGlobalPitchDegs() {
        return VectorUtils.getGlobalPitchDegs(VectorUtils.getDirectionUV(mStartLocation, mEndLocation));
    }
    ...
    public float getGlobalYawDegs() {
        return VectorUtils.getGlobalYawDegs(VectorUtils.getDirectionUV(mStartLocation, mEndLocation));
    }
    ...
    public void setLineWidth(float lineWidth) {
        ...
        if (lineWidth >= IKBone.MIN_LINE_WIDTH && lineWidth <= IKBone.MAX_LINE_WIDTH) {
            mLineWidth = lineWidth;
        } else // ...otherwise throw an IllegalArgumentException.
        {
            throw new IllegalArgumentException("Line width must be between " + IKBone.MIN_LINE_WIDTH + " and " + IKBone.MAX_LINE_WIDTH + " inclusive.");
        }
    }
